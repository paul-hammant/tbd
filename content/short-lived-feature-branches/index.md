...
commits landing in trunk.

One key rule is the length of live of the branch, before it gets merged and itself deleted. Another rule is around how
...
result in your change being a single commit, a the HEAD of the branch (as Subversion would always do).
