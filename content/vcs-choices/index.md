...
Perforce并没有集成到其传统服务器守护程序中的代码审查功能。通过一个名为GitSwarm的定制修改后的Gitlab安装版，使得现在Perforce具有代码审查功能。它还具有另一种安装方式，即仅仅安装Swarm（稍旧的产品），而不提供GitSwarm的Git功能，但是添加了许多团队功能，如代码审查。
